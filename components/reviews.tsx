                        ...
                        <li key={pr.id} className="p-4 flex flex-col gap-2">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="flex items-center gap-4"><Chip color={pr.status === "CLOSED" ? "danger" : "primary"} size="sm">{pr.status}</Chip> {pr.status === "MERGED" ? `by <strong>${pr?.metadata?.merged_by?.login}}</strong>` : ''}</div>
                                </div>
                            </div>
